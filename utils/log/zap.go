...
func newLogger(logFolder, logName string, minLevel zapcore.Level) {
...
func InstanceLogObject(logFolder, logName string, minLevel zapcore.Level) {
	once.Do(func() {
		newLogger(logFolder, logName, minLevel)
	})
}
